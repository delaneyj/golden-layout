...
describe('tabs', () => {
  ...
  it('closes tab and removes component', async () => {
    ...
    const remainingTabs = container.querySelectorAll('tx-tab');
    ...
    const remainingComponents = container.querySelectorAll('tx-component-container');
  ...
  it('handles tab overflow with scrolling', async () => {
    ...
    const stack = container.querySelector('tx-pane');
    const header = stack?.shadowRoot?.querySelector('tx-header');
